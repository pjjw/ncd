...
// go stdlib tempfile routines, pinched and modified to play
// nice with nagios' spool
...
func nextSuffix() string {
	...
	rand = r
	return strconv.Itoa(int(1e6 + r%1e6))[1:]
}
...
func spoolFile(dir, prefix string) (f *os.File, err os.Error) {
	if dir == "" {
		dir = os.TempDir()
	}
